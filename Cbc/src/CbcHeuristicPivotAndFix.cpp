...
void CbcHeuristicPivotAndFix::generateCpp(FILE *fp)
{
...
void CbcHeuristicPivotAndFix::resetModel(CbcModel * /*model*/)
{
...
int CbcHeuristicPivotAndFix::solution(double & /*solutionValue*/,
