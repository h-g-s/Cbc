...
void CbcHeuristicRandRound::generateCpp(FILE *fp)
{
...
void CbcHeuristicRandRound::resetModel(CbcModel *model)
{
...
*/
int CbcHeuristicRandRound::solution(double &solutionValue,
