/* $Id: CbcSolver.cpp 2372 2018-05-02 11:08:26Z forrest $ */
                ...
                if (type == CBC_PARAM_GENERALQUERY) {
                    ...
                    int printLevel =
                        parameters_[whichParam(CLP_PARAM_STR_ALLCOMMANDS,
                                parameters_)].currentOptionAsInteger();
                    int convertP[] = {2, 1, 0};
                    ...
                    switch (type) {
                        ...
                        case CLP_PARAM_ACTION_BARRIER:
                            if (goodModel) {
                                ...
                                integerStatus = -1;
                                double objScale =
                                    parameters_[whichParam(CLP_PARAM_DBL_OBJSCALE2, parameters_)].doubleValue();
                            ...
                            if (goodModel) {
                                ...
                                if (preSolve) {
                                    ...
                                    double presolveTolerance =
                                        parameters_[whichParam(CLP_PARAM_DBL_PRESOLVETOLERANCE, parameters_)].doubleValue();
                                    model2 =
                        ...
                        case CBC_PARAM_ACTION_BAB: // branchAndBound
                            ...
                            if (goodModel) {
                                ...
                                if (preProcess && type == CBC_PARAM_ACTION_BAB) {
                                    ...
                                    int threshold = 
                                        parameters_[whichParam(CBC_PARAM_INT_EXTRA_VARIABLES, parameters_)].intValue();
                                ...
                                if (gomoryAction && (complicatedInteger != 1 ||
                                    ...
                                    int cutLength =
                                        parameters_[whichParam(CBC_PARAM_INT_CUTLENGTH, parameters_)].intValue();
                                    if (cutLength != -1) {
                                ...
                                int iGenerator;
                                int cutDepth =
                                    parameters_[whichParam(CBC_PARAM_INT_CUTDEPTH, parameters_)].intValue();
...
#if 1
                                        int ixxxxxx = 
                                            parameters_[whichParam(CBC_PARAM_INT_MAXNODES, parameters_)].intValue();
