...
void CbcBranchDefaultDecision::initialize(CbcModel *model)
{
  bestCriterion_ = 0.0;
  bestChangeUp_ = 0.0;
  bestNumberUp_ = 0;
...
int CbcBranchDefaultDecision::betterBranch(CbcBranchingObject *thisOne,
...
void CbcBranchDefaultDecision::setBestCriterion(double value)
{
...
int CbcBranchDefaultDecision::bestBranch(CbcBranchingObject **objects, int numberObjects,
