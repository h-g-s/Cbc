...
void CbcHeuristicDiveGuided::generateCpp(FILE *fp)
{
...
bool CbcHeuristicDiveGuided::canHeuristicRun()
{
...
bool CbcHeuristicDiveGuided::selectVariableToBranch(OsiSolverInterface *solver,
